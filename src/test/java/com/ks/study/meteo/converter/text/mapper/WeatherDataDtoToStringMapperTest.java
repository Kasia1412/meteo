...
class WeatherDataDtoToStringMapperTest {
    private final WeatherDataDtoToStringMapper weatherDataDtoToStringMapper = new WeatherDataDtoToStringMapper();

    @Test
    void shouldMapFullDataToString() {
        //given
        ...
        //when
        String result = weatherDataDtoToStringMapper.map(weatherDataDto);
